 ...
 */
export declare function personKey(person: NamedPerson): string;
/**
 ...
 */
export declare function splitNewPeople<T extends NamedPerson>(existing: readonly NamedPerson[], extracted: readonly T[]): ImportSplit<T>;
